...
class ActionProvider {
  ...
  handlePaymentProcess = () => {
    const messages = [
      this.createChatBotMessage(
        "Kindly upload your proof of payment below. If you need assistance, feel free to reach out to our support team.How else can I help you today",
        {
          widget: 'proofOfPayment',
        }
        )
    ];
